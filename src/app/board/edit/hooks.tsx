...
export const useBoardEditPageState = () => {
 ...
 data: {
    ...
    const deleteCategoryFromDB = async (category:string) => {
        await axios.delete(`${process.env.NEXT_PUBLIC_API_ROUTER_URL}/board/category`, { data: { category } });
    };
    const editCategoryFromDB = async (originalCategory:string, newCategory:string) => {
        await axios.put(`${process.env.NEXT_PUBLIC_API_ROUTER_URL}/board/category`, { data: { originalCategory, newCategory } });
    };
    const insertFileToStorage = async (file:File) => {
        const formData = new FormData();
        formData.append('file', file);
        const response = await axios.post(`${process.env.NEXT_PUBLIC_API_ROUTER_URL}/board/storage`, formData);
